...
public class AppLibGeneral {
	...
	public static int getConfigurationInt(Context context, String PREF_NAME, String PREF_KEY, int defaultValue) {
		SharedPreferences prefConfig = context.getSharedPreferences(PREF_NAME, 0);
		return prefConfig.getInt(PREF_KEY, defaultValue);
	}
	...
	public static String getConfigurationString(Context context, String PREF_NAME, String PREF_KEY, String defaultValue) {
		SharedPreferences prefConfig = context.getSharedPreferences(PREF_NAME, 0);
		return prefConfig.getString(PREF_KEY, defaultValue);
	}
	...
	public static int getScreenShort(Context context) {
		...
		int screenShort = (screenWidth<screenHeight)?screenWidth:screenHeight;
		return screenShort;
	}
	 ...
	 *
	 * @param context
	 * @return Amount of available memory in MB (megabyte)
	 */
	public static long getAvailableMemory(Context context) {
		ActivityManager.MemoryInfo mi = new ActivityManager.MemoryInfo();
		ActivityManager activityManager = (ActivityManager) context.getSystemService(Activity.ACTIVITY_SERVICE);
		activityManager.getMemoryInfo(mi);
		long availableMemInMB = mi.availMem / 1048576L;
		return availableMemInMB;
	}
